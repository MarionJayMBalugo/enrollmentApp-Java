...
public class EnrollMentSystem {
    ...
    public static void main(String[] args) throws IOException {
        ...
        while (endAll) {
            File file
                    = new File(new BufferedWriter(new FileWriter("C:\\Users\\balugoma_SD2023\\Desktop\\Accounts.txt", true)),
                            new BufferedWriter(new FileWriter("C:\\Users\\balugoma_SD2023\\Desktop\\Personal_Info.txt", true)),
                            new BufferedWriter(new FileWriter("C:\\Users\\balugoma_SD2023\\Desktop\\Courses.txt", true)));
            counter = Counter.count(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Accounts.txt")));
            courCount = Counter.count(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Courses.txt")));
            infoCount = Counter.count(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Personal_Info.txt")));
            File file1 = new File();
            file1.sendArray(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Personal_Info.txt")));
            Array.setInfoList(file1.getList());
            file.sendArray(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Accounts.txt")));
            Array.setAccList(file.getList());
            File file2 = new File();
            file2.sendArray(new BufferedReader(new FileReader("C:\\Users\\balugoma_SD2023\\Desktop\\Courses.txt")));
...
//deleting
                    ...
                    case 4:
                        ...
                        while (endUpdate) {
                                ...
                                case 1:
                                    if (Array.getInfoList().size() != 0) {
                                        ...
                                        try {
                                            ...
                                            System.out.println("please just enter a digit");
                                            continue;
                                        }
                            ...
                            endUpdate = Choice.endChoice(write, "update");
                        }
                        break;
                    case 5:
                        if (Array.getAccList().size() != 0 && Array.getInfoList().size() != 0 && Array.getCourseList().size() != 0) {
